    ...
    def _build_archive_outputs(self, all_activities: List[Dict], all_wellness: List[Dict],
        ...
        for a in all_activities:
            ...
            activity_records.append({
                "date": date, "id": a.get("id"), "name": a.get("name"),
                "type": a.get("type"), "tss": round(tss, 1),
                "moving_seconds": secs, "distance_km": round(distance_m / 1000.0, 2),
        ...
        archive = {
            ...
            "notes": [
                ...
                "No missing metric is estimated; unavailable values are null.",
